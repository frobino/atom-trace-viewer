...
export default class AtomGoogleView {
   ...
   loadTemplate(name){
      // move into lib/templates, to show this is custom for this plugin?
   ...
   /**
    * Parses a custom json object to create a list of HTML elements
    * to generate webpage.
    *  
    * @param {*} template object parsed from input json string (JSON.parse(...))
    * @returns a list of HTML elements, parsed from the json template.
    */
